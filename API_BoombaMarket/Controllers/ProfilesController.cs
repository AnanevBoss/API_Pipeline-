...
namespace API_BoombaMarket.Controllers
{
    ...
    public class ProfilesController : ControllerBase
    {
        ...
        public ProfilesController(MarketplaceDBContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Profile>> PostProfile(Profile profile)
        {
          if (_context.Profiles == null)
          {
              return Problem("Entity set 'MarketplaceDBContext.Profiles'  is null.");
          }
        ...
        public async Task<ActionResult<Profile>> GetProfileById(int? id)
        {
            ...
            var profile = await _context.Profiles.FirstOrDefaultAsync(a => a.UserId == id);
